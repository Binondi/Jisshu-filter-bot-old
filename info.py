...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', 'https://t.me/tbbohelp'))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/tbbohelp') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
